                    ...
                    <form id="login-form">
		                <div class="modal-body">
				    		<div id="div-login-msg">
                                ...
                                <span id="text-login-msg">Veillez Remplir le Formulaire.</span>
                            </div>
                            <input id="login_username" class="form-control" type="text" placeholder="Nom" (type ERROR for error effect)" required">
